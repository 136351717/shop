...
<div class="span10 last">
		<div class="topNav clearfix">
			<ul>
				...
				<s:else>
					<li id="headerLogin" class="headerLogin" style="display: list-item;">
						<s:property value="#session.existUser.name"></s:property>
					</li>
					<li id="headerLogin" class="headerRegister" style="display: list-item;">
	...
	<div class="span24">
		<ul class="mainNav">
					...
					<s:iterator var="c" value="#session.cList">				
						<li>
							<a href="${ pageContext.request.contextPath }/product_findByCid.action?cid=<s:property value="#c.cid"/>&page=1"><s:property value="#c.cname"></s:property></a>
						</li>
					</s:iterator>
